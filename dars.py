    ...
    with tqdm(total=Tmax) as pbar: 
        ...
        for t in range(Tmax):
            ...
            for particula in range(len(L)):
                ...
                if (h_sitio_esquerda < h_sorteado and h_sitio_esquerda < h_sitio_direita):
                    L[sitio_esquerda] = L[sitio_esquerda] + 1
                elif (h_sitio_direita < h_sorteado and h_sitio_direita < h_sitio_esquerda):
                    L[sitio_direita] = L[sitio_direita] + 1
                else:
                    L[sitio] = L[sitio] + 1
